...
describe('ControlledCheckbox', () => {
    it('renders with correct label', () => {
        renderWithTheme(<ControlledCheckbox checked={false} onChange={() => {}} label="Chcę być moderatorem" />);
        expect(screen.getByLabelText('Chcę być moderatorem')).toBeInTheDocument();
    });

    it('shows checkbox as checked when prop is true', () => {
        renderWithTheme(<ControlledCheckbox checked={true} onChange={() => {}} label="Zgoda" />);
