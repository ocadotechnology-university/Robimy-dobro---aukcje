...
@Repository
public class GoogleDriveLocalDriveImageRepository implements ImageRepository {

    GoogleDriveService googleDriveService;
    LocalDriveService localDriveService;

    public GoogleDriveLocalDriveImageRepository(GoogleDriveService googleDriveService, LocalDriveService localDriveService) {
